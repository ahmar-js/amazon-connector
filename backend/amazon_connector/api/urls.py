...
urlpatterns = [
    ...
    path('fetch-missing-orders/', FetchMissingOrdersView.as_view(), name='fetch_missing_orders'),
    path('fetch-orders-by-id/', FetchOrdersByIdView.as_view(), name='fetch_orders_by_id'),
